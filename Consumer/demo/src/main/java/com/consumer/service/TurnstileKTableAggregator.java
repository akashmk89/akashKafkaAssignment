...
@Service
@Slf4j
public class TurnstileKTableAggregator {
    public String topic = "org.station.stations";
    public void addAggregatedTransformedStationToKafka(){
...
//        KGroupedTable<Integer,String> KGS1 = kTable.groupBy(
//                (k, v) -> KeyValue.pair(v.toString(),v),
